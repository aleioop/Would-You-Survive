...
def self.bmi_factor(user)
  ...
  def self.create_data
    ...
    Result.create(era_id: 3, body: "As Lord of the Worcestershire Commune you only survived CODESUB months in the Dark Ages before being killed in a peasant uprising.", is_dead: true)
